...
if(matrix[2]==1){
		...
		for (i = umax; i>=umin+1; i--) {
            ...
            $("#thumb-container").append("<a onclick='"+quanta+"[0]="+i+";sessionStorage.setItem(quanta, JSON.stringify(matrix));' id='nb' style='position:relative;  text-align: center;text-decoration:none;' href='artwork.html' ><img id='" +"nb "+i+"' style='border: 2px solid rgba(0, 5, 20, 1);padding:0px;cursor: pointer;position:relative; width:200px; height:200px; -webkit-touch-callout: none; -webkit-user-select: none;-khtml-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;' src=" + "asset/pages/page_"+ i +"/subcontent/" + "thumb.jpg" + "></img><d id='" +"nb2 "+i+"' style='color:rgba(209,174,95,1);position:absolute; z-index:2; left:25px;top:-80px; text-align: center;font-family: Cabin, Helvetica, Arial, sans-serif;background-color:rgba(0, 5, 20, 0.8);border-radius:20px;text-decoration:none;padding: 0px 10px 0px 10px;'>"+i+"</d></a>");}


}else{
for (i = umax; i>=umin+1; i--) {

            $("#thumb-container").append("<a onclick='"+quanta+"[0]="+chain[i-1]+";sessionStorage.setItem(quanta, JSON.stringify(matrix));' id='nb' style='position:relative;  text-align: center;text-decoration:none;' href='artwork.html' ><img id='" +"nb "+i+"' style='border: 2px solid rgba(0, 5, 20, 1);padding:0px;cursor: pointer;position:relative; width:200px; height:200px; -webkit-touch-callout: none; -webkit-user-select: none;-khtml-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;' src=" + "asset/pages/page_"+ chain[i-1]+"/subcontent/" + "thumb.jpg" + "></img><d id='" +"nb2 "+chain[i-1]+"' style='color:rgba(209,174,95,1);position:absolute; z-index:2; left:25px;top:-80px; text-align: center;font-family: Cabin, Helvetica, Arial, sans-serif;background-color:rgba(0, 5, 20, 0.8);border-radius:20px;text-decoration:none;padding: 0px 10px 0px 10px;'>"+chain[i-1]+"</d></a>");}
}
